...
| openclaw | (custom) | 7000 | Aulë Telegram + Discord bot, memory, tools |
...
- The openclaw compose lives at `/data/compose/openclaw/` outside the standard `/mnt/work/` structure.
