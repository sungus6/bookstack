...
- Family Member - Contact & Identity
...
## Current Status
- **Living Situation:** [Own home / Apartment / With family]
- **Employment Status:** [Employed / Retired / Student]
- **Current Employer:** 
- **Health Status:** [General / Any critical conditions to know]
...
- **Naturalization Papers:** [Location if applicable]
- **Professional Licenses:** 
- **State Tax ID (IL-PIN, etc.):** 
...
## Daily Routine (Helps others notice if something's wrong)
- **Typical Wake Time:** 
- **Work Schedule:** 
- **Regular Appointments:** [Days/times]
- **Expected Check-ins:** [Who they talk to daily]
- **Red Flags:** [What would indicate something's wrong]
...
| Medication Name | Dosage | Frequency | Prescribing Doctor | Pharmacy | Refill Due |
|----------------|--------|-----------|-------------------|----------|------------|
|  |  |  |  |  |  |
...
- **Phone:** 
- **Rx Number/Account:** 
- **Auto-Refill Enrolled:** Yes/No
- **Mail Order Pharmacy:** [If different]
...
| Measurement | Current | Date Recorded | Target/Normal Range |
|-------------|---------|---------------|---------------------|
| Height |  |  |  |
| Weight |  |  |  |
| BMI |  |  |  |
...
| Relationship | Conditions | Age at Diagnosis | Notes |
|--------------|------------|------------------|-------|
| Father |  |  |  |
| Mother |  |  |  |
| Siblings |  |  |  |
...
- **Diet Type:** 
- **Alcohol Use:** 
- **Tobacco Use:** Never / Former [quit date] / Current
- **Sleep Pattern:** [Average hours, any issues]
- **Stress Level:** 

## Medical Records & Documents
- **Physical Records Location:** 
- **Digital Records:** [Portal URLs]
- **Medical Imaging:** [Where stored - CDs, online]
- **Test Results:** [Filing system]

## Appointment History
| Date | Provider | Reason | Follow-up Needed | Notes |
|------|----------|--------|------------------|-------|
|  |  |  |  |  |

## Medical Equipment & Devices
| Device | Type | Serial Number | Prescribing Doctor | Supplier | Service/Battery Change |
|--------|------|---------------|-------------------|----------|----------------------|
| CPAP |  |  |  |  |  |
| Glucose Monitor |  |  |  |  |  |
...
- **Current Mental Health Medications:** [See Medications section]
- **Crisis Resources:** 
...
- **Cemetery/Burial:** 
  - Name: 
  - Location: 
  - Plot Purchased: Yes/No
  - Plot Number: 
- **Memorial Service:** 
  - Type: [Religious / Secular / Celebration of Life]
  - Location Preference: 
  - Music Preferences: 
  - Readings/Speakers: 
- **Obituary:** 
  - Pre-written: Yes/No [Location]
...
- **Body Donation to Science:** Yes/No
  - Organization: 
...
- **Social Media Accounts:** 
  ...
  - Legacy Contact: 
  - Other Platforms: 
- **Email Accounts:** [Instructions for closure]
...
- **Items with Sentimental Value:** 
  | Item | Intended Recipient | Location |
  |------|-------------------|----------|
  |  |  |  |

## Estate Planning Checklist
- [ ] Will - Current and signed
- [ ] Living Trust - If applicable
- [ ] Power of Attorney (Financial) - Current
- [ ] Healthcare Power of Attorney - Current
- [ ] Living Will / Advance Directive - Current
- [ ] POLST - If applicable
- [ ] Beneficiary designations - All reviewed in past year
- [ ] Funeral arrangements - Documented or pre-arranged
- [ ] Digital asset plan - Documented
- [ ] Executor/POA - Informed and willing
- [ ] Family - Discussed wishes
- [ ] Documents - Stored securely, family knows location
- [ ] Attorney - Contact info current
...
## Review Schedule
- **Annual Review Date:** [Choose consistent date each year]
...
- [ ] PTO payout - Amount: _______ Date: _______
- [ ] Bonus payout
- [ ] Equipment returned
- [ ] Access credentials deactivated
- [ ] Benefits continuation (COBRA) info received
- [ ] 401(k) rollover options reviewed
- [ ] Stock options exercised/forfeited
- [ ] Non-compete/NDA reviewed
...
- **Type:** [University / College / Community College / Trade School / High School]
...
| Activity | Role | Dates | Description |
|----------|------|-------|-------------|
| Club/Organization |  |  |  |
| Sports |  |  |  |
| Student Government |  |  |  |
...
#### Academic Records
- **Transcript Location:** [Physical / Digital]
- **How to Request:** 
- **Diploma Location:** 
- **Official Seal/Verification:** [How to verify]

#### Housing & Residence
| Year | Residence | Address | Roommates |
|------|-----------|---------|-----------|
| Freshman Year |  |  |  |
| Sophomore Year |  |  |  |
...
- **Scholarships Received:** 
  - 
- **Student Loans:** [Link to loan details in Financial page]
- **Work-Study:** Yes/No
- **Total Cost:** 

#### Notable Professors / Mentors
| Name | Department | Relationship | Contact If Maintained |
|------|------------|--------------|---------------------|
|  |  |  |  |
...
**See Financial Accounts page for detailed loan information**
...
## Academic References
| Name | Title/Institution | Relationship | Last Contact | Contact Info |
|------|------------------|--------------|--------------|--------------|
|  |  | Professor / Advisor / Mentor |  |  |

## Transcript Request Information
| Institution | How to Request | Cost | Turnaround Time | Last Requested |
|------------|----------------|------|----------------|----------------|
|  |  |  |  |  |
...
- **Forwarding Rules:** 
- **Filters/Labels:** [Key ones]
- **Important Folders:** 
- **Aliases:** 
- **Legacy Contact:** [Who can access if deceased]
...
| Instagram | Archive / Delete |  | Download photos first |
| LinkedIn | Leave / Delete |  |  |
...
- **Access Instructions:** 
- **What They Should Do:** 
  - [ ] Access password manager using emergency access
  - [ ] Download photo/video archives from cloud
  - [ ] Memorialize or delete social media per wishes
...
|--------------|------------------|--------|----------|-------------|
| Social Media | Facebook, Instagram | Memorialize | High | Digital Executor |
| Email | Primary personal | Keep active 1 year for notifications | High | Spouse |
| Cloud Storage | Google Drive | Download important files then close | High | Digital Executor |
...
- **Emails:** [Specific folders/contacts to preserve]
- **Projects/Creative Work:** [Where stored]
...
- [ ] Password manager set up with strong master password
- [ ] Emergency access configured for password manager
- [ ] 2FA enabled on all critical accounts
- [ ] Backup codes saved securely
- [ ] Recovery emails/phones current
- [ ] Digital executor designated and informed
- [ ] Social media legacy contacts set
- [ ] Crypto recovery phrases stored ultra-securely
- [ ] Regular password updates scheduled
- [ ] Account inventory reviewed quarterly

## Security Incidents Log
| Date | Account | Incident | Action Taken | Resolution |
|------|---------|----------|--------------|------------|
...
| Restaurant | Type of Food | Location | Favorite Dish | Special Occasions |
|-----------|--------------|----------|---------------|-------------------|
|  |  |  |  |  |
...
- **Social Battery:** 
- **Ideal Weekend:** 
- **Party Style:** [Large gatherings / Small groups / One-on-one / Alone]
...
4. Medical & Health
5. Financial Accounts ← Secure
6. Legal & Estate ← Secure
7. Employment & Career
8. Education History
...
1. Emergency Information (life-saving)
2. Overview (quick reference)
3. Contact & Identity (daily use)
4. Medical & Health (important)

**Then add:**
5. Financial Accounts
6. Legal & Estate

**Finally (optional but nice):**
7. Digital Life
8. Employment
9. Education
10. Personal & Preferences
...
- "See Financial Accounts page for bank details"
- "Link to Insurance Policy page"
- "More about medications in Medical & Health"
...
1. **Pick one family member** (yourself!) to start
2. **Create their Book** in BookStack
3. **Start with Emergency Information** template - fill out the critical stuff
4. **Add Overview** page so family has quick reference
5. **Test it** - can you find what you need quickly?
...
✅ Easier to find info (logical grouping)
✅ More secure (control access per section)
✅ More maintainable (update what changes, leave rest alone)
✅ More usable (right amount of detail for each use case)
...
- **Online Banking:** [URL & login reference]
- **Debit Card Number:** [Last 4]
- **Customer Service:** 
- **Branch Location:** 
- **Relationship Manager:** 
- **Automatic Payments FROM this account:** 
- **Automatic Deposits TO this account:** 
- **Linked Accounts:** 
- **Overdraft Protection:** 
- **Account Statements:** [Where stored]
...
- **Payment Due Date:** 
- **Payment Account:** 
- **Loan Term:** [30-year, etc.]
- **Origination Date:** 
- **Maturity Date:** 
- **Escrow Account:** Yes/No
...
- **Filing Status:** 
- **Dependents:** 
- **Tax Documents Location:** 
- **Previous Tax Returns:** [Where stored]
